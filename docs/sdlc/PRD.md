...
| **FR-4** | The site provides a blog section with an index (reverse-chronological) and individual post pages. Posts support headings, code blocks, images, and links. | US-3, US-4 | Blog |
